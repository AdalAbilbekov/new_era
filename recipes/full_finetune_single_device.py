...
from torchtune.datasets import ISSAITextCompletionDataset, issai_text_completion_dataset
from torchtune.datasets import issai_instruct_dataset
...
class FullFinetuneRecipeSingleDevice(FTRecipeInterface):
    def __init__(self, cfg: DictConfig) -> None:
        ...
        self.sub_data = self.all_data.select(range(1000))
